...
namespace TheMysteryMarket\Page\FrontEnd
{
     ...
     */
    class PrivacyPolicy extends FrontEndBase
    {
        /**
        ...
        public function __construct()
        {
            ...
            $this->SetTitle("The Mystery Market: Privacy Policy")
                ...
                ->SetOgURL("https://themysterymarket.com/index.php?page=PrivacyPolicy")
                ->SetOgDescription("Privacy Policy")
                ->SetBodyClass("privacy-policy-page")
                ->SetBodyHTML($this->GenerateHeader().'<main>'.$this->GeneratePage().'</main>'.$this->GenerateFooter());
        }
...
<li>
<p>By visiting this page on our website: <a href="https://www.themysterymarket.com/index.php?page=PrivacyPolicy" rel="external nofollow noopener" target="_blank">https://www.themysterymarket.com/index.php?page=PrivacyPolicy</a></p>
</li>
<li>
